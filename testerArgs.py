...
for j in range(1,21):
    ...
    with open(".\\supplierlist\\supplierlist1.csv",
    ...
    if matchRow == []:
        with open("C:\\Users\\delis\\Documents\\UNI4\\ENGLYMPICS\\CompetitionPackage\\supplierlist\\supplierlist2.csv",
                  "r", encoding="utf8") as f:
            supplierList = csv.DictReader(f)
            matchRow = []
            i = 0
            ...
            f.close()
    if matchRow == []:
        with open("C:\\Users\\delis\\Documents\\UNI4\\ENGLYMPICS\\CompetitionPackage\\supplierlist\\supplierlist1.csv",
                  "r", encoding="utf8") as f:
            supplierList = csv.DictReader(f)
            matchRow = []
            i = 0
